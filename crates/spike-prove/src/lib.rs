//! THROWAWAY M3 spike.
//!
//! Question: can a browser (single-threaded WASM, stable toolchain) build the
//! Orchard/Ironwood post-NU6.3 proving key and produce one bundle proof, and what does
//! that cost in time and linear memory?
//!
